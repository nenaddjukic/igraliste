 ...
 * @version $Revision: $
 */
@ConnectionDefinition(connectionFactory = IgralisteConnectionFactory.class,
   connectionFactoryImpl = IgralisteConnectionFactoryImpl.class,
   connection = IgralisteConnection.class,
   connectionImpl = IgralisteConnectionImpl.class)
public class IgralisteManagedConnectionFactory implements ManagedConnectionFactory, ResourceAdapterAssociation
{
    ...
    * Default constructor
    */
   public IgralisteManagedConnectionFactory()
   {
         ...
         Subject subject, ConnectionRequestInfo cxRequestInfo) throws ResourceException
   {
      ...
      while (result == null && it.hasNext())
      {
         ...
         if (mc instanceof IgralisteManagedConnection)
         {
            result = mc;
         }
